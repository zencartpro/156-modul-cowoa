 ...
 * @version $Id: customers_without_order.php for COWOA 2019-07-04 07:35:51Z webchills $
 */
    ...
    case 'deleteconfirm':
      ...
      default:
        ...
        $customers = $db->Execute("select c.customers_id, c.customers_gender, c.customers_firstname,
                                          ...
                                          c.COWOA_account, c.customers_authorization, c.customers_referral, o.date_purchased
  ...
  <body onLoad="init()">
    ...
    <div class="container-fluid">
      ...
      if ($action == 'edit' || $action == 'update') {
       ...
       <?php echo zen_draw_label(COWOA_SECTION_HEADING, 'COWOA_account', 'class="col-sm-3 control-label"'); ?>
          ...
          <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 configurationColumnLeft">
            <table class="table table-hover">
              <thead>
                <tr class="dataTableHeadingRow">
                  ...
                  <th class="dataTableHeadingContent text-center">
                    ...
                    <a href="<?php echo zen_href_link(basename($PHP_SELF), zen_get_all_get_params(array('list_order', 'page')) . 'list_order=COWOA-asc', 'NONSSL'); ?>"><?php echo ($_GET['list_order'] == 'COWOA-asc' ? '<span class="SortOrderHeader">Asc</span>' : '<span class="SortOrderHeaderLink">Asc</span>'); ?></a>&nbsp;
                    <a href="<?php echo zen_href_link(basename($PHP_SELF), zen_get_all_get_params(array('list_order', 'page')) . 'list_order=COWOA-desc', 'NONSSL'); ?>"><?php echo ($_GET['list_order'] == 'COWOA-desc' ? '<span class="SortOrderHeader">Desc</span>' : '<span class="SortOrderHeaderLink">Desc</span>'); ?></a>
                  </th>
                  <!-- COWOA+ -->               
              ...
              <tbody>
                  ...
                  $customers_query_raw = "select c.customers_id, c.customers_lastname, c.customers_firstname, c.customers_email_address, c.customers_group_pricing, c.customers_telephone, c.customers_authorization, c.customers_referral, c.COWOA_account,
