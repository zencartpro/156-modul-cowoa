 ...
 * @version $Id: orders.php for COWOA 2019-11-02 17:04:51Z webchills $
 */
  ...
  switch ($action) {
    case 'edit':
      ...
      if (!empty($_GET['download_reset_on'])) {
        ...
        $check_status = $db->Execute("SELECT customers_name, customers_email_address, orders_status, date_purchased, COWOA_order
                                      FROM " . TABLE_ORDERS . "
...
// Sort Listing
                    switch ($_GET['list_order']) {
                      ...
                      case "company-desc":
                        ...
                        break;
                      case "COWOA-asc":
                        $disp_order = "o.COWOA_order";
                        break;
                      case "COWOA-desc":
                      $disp_order = "o.COWOA_order DESC";
                      break;
                      default:
...
// create search filter
                  ...
                  $orders_query_raw = "select " . $search_distinct . " o.orders_id, o.customers_id, o.customers_name, o.payment_method, o.shipping_method, o.date_purchased, o.last_modified, o.currency, o.currency_value, o.order_device, o.COWOA_order, s.orders_status_name, ot.text as order_total" .
                      $new_fields . "
                          from (" . TABLE_ORDERS . " o " .
                      $new_table . ")
...
?>
  <td class="dataTableContent text-center"><?php if ($orders->fields['COWOA_order'] == 1) echo '<b>X</b>'; ?></td>            
<?php
  // -----
  // A watching observer can provide an associative array in the form:
  //
